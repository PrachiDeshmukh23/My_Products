...
async function main() {
  ...
  const image = '/images/agri-power.png';
  const input = {
    id: 5,
    slug: 'agri-power',
    name: 'Agri Power',
    badge: 'DRIP ONLY',
    desc: 'Agri Power is a micronutrient crop-nutrition formulation for drip application. It supplies iron, zinc, copper, boron and manganese to support balanced crop development.',
    mrp: 3340,
    weight: 5,
    unit: 'Ltr',
    img: image,
    ...
    specifications: [
      ...
      { label: 'MRP', value: '₹3,340' },
      { label: 'Recommended application', value: 'Drip application only' },
